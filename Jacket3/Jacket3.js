...
var jsonData = {
    "product": [{
        ...
        "materials":"90% полиэстер / 10% шерсть.",
        "color":"Чёрно-бежевый, в клетку",
        "description":"Тренерская куртка из смесовой шерстяной ткани в клетку. Особенности включают ватную стеганую подкладку, 2 глубоких внешних кармана с фирменным флагом «Бен Шерман» на шве кармана, 1 внутренний карман и короткую планку на подоле."
    }]
};
...
// Массив изображений
var images = [
    "../images/BenShermanJacket.webp", 
    "../images/BenShermanJacket2.webp", 
    "../images/BenShermanJacket3.webp", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Wool Blend Check Coach Jacket", // Примерное название, возможно, вам нужно будет его изменить
        price: 259.00, // Примерная цена, возможно, вам нужно будет ее изменить
