...
var jsonData = {
    "product": [{
        "cost":49.00,
        "name":"SIGNATURE BRIGHTON BEACH CLUB TEE",
        "materials":"100% хлопок",
        "color":"Черный",
        "description":"Футболка стандартного кроя из 100% органического хлопка, сертифицированного GOTS. Эта футболка, вдохновленная музыкой, украшена принтом на груди и рисунком на спине."
    }]
};
...
// Массив изображений
var images = [
    "../images/BenShermanShirt.webp", 
    "../images/BenShermanShirt2.webp", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "SIGNATURE BRIGHTON BEACH CLUB TEE", // Примерное название, возможно, вам нужно будет его изменить
        price: 49.00, // Примерная цена, возможно, вам нужно будет ее изменить
