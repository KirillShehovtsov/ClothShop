...
var jsonData = {
    "product": [{
        ...
        "color":"Чёрный",
        "description":"Оригинальная джинсовая куртка, созданная с высочайшим мастерством, с уютной подкладкой из шерпы.Металлические пуговицы с логотипом Levis® и заостренные V-образные строчки делают модель мгновенно узнаваемой.Эта культовая незаменимая вещь действительно хорошо смотрится на всех, даже в увеличенном или уменьшенном размере."
    }]
};
...
// Массив изображений
var images = [
    "../images/LevisJacket.webp", 
    "../images/LevisJacket2.jpeg", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Levis YPE III SHERPA TRUCKER JACKET", // Примерное название, возможно, вам нужно будет его изменить
        price: 108.00, // Примерная цена, возможно, вам нужно будет ее изменить
