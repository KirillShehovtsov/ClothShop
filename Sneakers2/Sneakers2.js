...
var jsonData = {
    "product": [{
        ...
        "name":"GEL-CUMULUS 26",
        "color":"Белый/Чёрный",
        "description":"Технология PureGEL™, используемая в обуви, повышает мягкость и амортизацию, уменьшая нагрузку на суставы. Acics обновили дизайн межподошвы, объединив пену FF BLAST™ PLUS с подошвой FluidRide™, чтобы обеспечить дополнительный комфорт во время бега."
    }]
};
...
// Массив изображений
var images = [
    "../images/AsicsSnikers.webp", 
    "../images/AsicsSnikers2.webp", 
    "../images/AsicsSnikers3.webp"
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "GEL-CUMULUS 26", // Примерное название, возможно, вам нужно будет его изменить
        price:  160.00, // Примерная цена, возможно, вам нужно будет ее изменить
        img: "../images/AsicsSnikers.webp",
