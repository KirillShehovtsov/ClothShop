...
var jsonData = {
    "product": [{
        ...
        "materials":"90% хлопок 5% полиэстер 5% эластан",
        "color":"Темно-синий",
        "description":"Современный. Чистый. Изысканный. Calvin Klein Menswear — это новый взгляд на классический крой с изысканными деталями. Комбинируйте модели для современного гардероба как днем, так и вечером."
    }]
};
...
// Массив изображений
var images = [
    "../images/KelvinKleinJeansV2.webp", 
    "../images/KelvinKleinJeansV2-2.webp", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Kelvin Klein Jean Fuselé", // Примерное название, возможно, вам нужно будет его изменить
        price: 139.90, // Примерная цена, возможно, вам нужно будет ее изменить
