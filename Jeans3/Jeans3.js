...
var jsonData = {
    "product": [{
        "cost":99.90,
        "name":"Jean Slim",
        "materials":"92% хлопок 6% эластомультиэстер 2% эластан",
        "color":"Темно-синий",
...
// Массив изображений
var images = [
    "../images/KelvinKleinJeans.webp", 
    "../images/KelvinKleinJeans2.webp", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Jean Slim", // Примерное название, возможно, вам нужно будет его изменить
        price: 99.90, // Примерная цена, возможно, вам нужно будет ее изменить
