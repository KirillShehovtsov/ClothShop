...
var jsonData = {
    "product": [{
        ...
        "materials":"99% хлопок, 1% эластан.",
        "color":"Темно-синий",
        "description":"Современные джинсы прямого кроя от BOSS Menswear. Эти джинсы стандартной посадки, отделанные нашивкой с логотипом, изготовлены из комфортного эластичного денима, прополосканного до темно-синего тона, что позволяет адаптировать их в течение недели."
    }]
};
...
// Массив изображений
var images = [
    "../images/HugoJeans.webp", 
    "../images/HugoJeans2.webp", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "REGULAR-FIT JEANS", // Примерное название, возможно, вам нужно будет его изменить
        price: 158.00, // Примерная цена, возможно, вам нужно будет ее изменить
