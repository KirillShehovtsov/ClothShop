...
var jsonData = {
    "product": [{
        ...
        "name":"New Balace 530",
        "color":"Белый",
        "description":"Мужские кроссовки 530 — это возврат к одной из наших классических кроссовок для бега. Эта повседневная модель сочетает в себе повседневный стиль и современные технологии. Амортизация ABZORB под ногами обеспечивает непревзойденный комфорт. Придайте своему шагу нотку ретро с мужскими кроссовками 530."
    }]
};
...
// Массив изображений
var images = [
    "../images/NewBalanceSnikers.jpg", 
    "../images/NewBalanceSnikers2.jpg"
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "New Balace 530", // Примерное название, возможно, вам нужно будет его изменить
        price: 99.99, // Примерная цена, возможно, вам нужно будет ее изменить
