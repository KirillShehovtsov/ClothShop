...
var jsonData = {
    "product": [{
        ...
        "color":"Синий",
        "description":"Футболка Nike Sportswear Club изготовлена ​​из хлопка классического кроя и обеспечивает абсолютный комфорт с первого раза. Вышитый логотип Futura на груди создает фирменный образ Nike."
    }]
};
...
// Массив изображений
var images = [
    "../images/NikeShirtV2.png", 
    "../images/NikeShirtV2-2.png", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Nike Sportswear Club", // Примерное название, возможно, вам нужно будет его изменить
        price: 24.99, // Примерная цена, возможно, вам нужно будет ее изменить
