...
var jsonData = {
    "product": [{
        ...
        "color":"Черный",
        "description":"Мужская беговая футболка Nike Dri-FIT Miler обеспечивает оптимальный комфорт благодаря дышащей влагоотводящей ткани. На спине имеется сетчатая панель для целевой вентиляции."
    }]
};
...
// Массив изображений
var images = [
    "../images/NikeShirt.png", 
    "../images/NikeShirt2.png", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Nike Dri-FIT Miler", // Примерное название, возможно, вам нужно будет его изменить
        price: 34.99, // Примерная цена, возможно, вам нужно будет ее изменить
