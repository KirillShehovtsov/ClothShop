...
var jsonData = {
    "product": [{
        ...
        "materials": "Водоотталкивающая и ветронепроницаемая ткань с колор-блоками",
        "color": "Серый-дымчатый",
        "description": "Создайте культовый образ Windrunner и выдержите холод в этой подрумяненной куртке с капюшоном. Он имеет классический вид пуховика и подкрепляется изоляционной способностью утеплителя PrimaLoft® ThermoPlume®. Технология Nike Storm-FIT защищает от таких факторов, как ветер и вода, и помогает вам чувствовать себя комфортно в суровых погодных условиях. Свободная посадка дает вам немного места, чтобы надеть под себя одежду в очень прохладные дни."
    }]
};
...
var images = [
    ...
    "../images/NikeJacket2.png", 
    "../images/NikeJacket3.png"
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Nike Windrunner PrimaLoft", // Примерное название, возможно, вам нужно будет его изменить
        price: 160.99, // Примерная цена, возможно, вам нужно будет ее изменить
