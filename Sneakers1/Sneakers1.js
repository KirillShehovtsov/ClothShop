...
var jsonData = {
    "product": [{
        ...
        "color":"Белый/Чёрный",
        "description":"Всегда стильно, всегда модно. Верные истории и наследию Иордании, Air Jordan 1 Low предлагают вам оптимальный комфорт в течение всего дня. Выберите свои цвета и выделитесь своим культовым силуэтом, выполненным из сочетания материалов премиум-класса и дополненным инкапсулированной вставкой Air в пятке."
    }]
};
...
// Массив изображений
var images = [
    "../images/NikeSnikers.jpeg", 
    "../images/NikeSnikers2.png", 
    "../images/NikeSnikers3.jpeg"
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Air Jordan 1 Low", // Примерное название, возможно, вам нужно будет его изменить
        price: 129.99, // Примерная цена, возможно, вам нужно будет ее изменить
