...
var jsonData = {
    "product": [{
        ...
        "materials":"Верх: 50% нейлон/50% хлопок.Подкладка: 100% хлопок.",
        "color":"Зелёный",
        "description":"Модель RAF MK3, вдохновленная британским военным стилем, оснащена множеством практичных карманов и манжетами на липучках для регулируемой посадки. Это идеальный легкий внешний слой для более низких температур в любое время года."
    }]
};
...
// Массив изображений
var images = [
    "../images/AlphaindenstrisJacket.jpg", 
    "../images/AlphaindenstrisJacket2.jpg", 
    "../images/AlphaindenstrisJacket3.jpg", 
];
...
function addToCart() {
    ...
    var productToAdd = {
        name: "Raf MK3 Mod Jacket", // Примерное название, возможно, вам нужно будет его изменить
        price: 300.00, // Примерная цена, возможно, вам нужно будет ее изменить
